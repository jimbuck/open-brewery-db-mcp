...
import { Brewery, BrewerySchema, GetBreweryByIdInput, GetBreweryByIdSchema, GetRandomBreweryInput, GetRandomBrewerySchema, SearchBreweriesInput, SearchBreweriesSchema } from './types.js';


export class OpenBreweryDBApi {
  private readonly baseUrl = 'https://api.openbrewerydb.org/v1/breweries';

  public async searchBreweries(args: SearchBreweriesInput) {
  ...
  public async getBreweryById(args: GetBreweryByIdInput) {
  ...
  public async getRandomBrewery(args: GetRandomBreweryInput) {
